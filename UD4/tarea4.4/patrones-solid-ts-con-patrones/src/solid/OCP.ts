...
class DescuentoHalloween implements Descuento {
  aplicar(precio: number): number {
      return precio *0.6;
  }
}
...
const carritoHalloween = new CarritoOCP(new DescuentoHalloween());

console.log(carritoNormal.calcularPrecio(100));
console.log(carritoNavidad.calcularPrecio(100));
console.log(carritoHalloween.calcularPrecio(594));
